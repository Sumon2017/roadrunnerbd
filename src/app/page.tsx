        ...
        <div className="grid md:grid-cols-2 gap-20">
          <div className="space-y-6">
            ...
            <div className="flex flex-col gap-4">
              <a
                href="https://maps.app.goo.gl/AJLR7rromNqm1s83A"
                target="_blank"
              ...
              <div className="w-full max-w-xs rounded-sm overflow-hidden border border-zinc-800 opacity-80 hover:opacity-100 transition-opacity">
                <iframe
                  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d6896.0354699464815!2d90.46706571263725!3d23.71000621778768!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3755b708d6ce44fd%3A0xa86ccfc10499dd6e!2sDogair%20Bazar!5e0!3m2!1sbn!2sbd!4v1771626523565!5m2!1sbn!2sbd"
                  width="100%"
                  height="120"
                  style={{ border: 0 }}
          ...
          <div className="text-[10px] font-bold uppercase tracking-widest text-zinc-500 flex flex-col gap-2">
            <div className="flex flex-col gap-3">
              <a href={`https://wa.me/${process.env.NEXT_PUBLIC_WHATSAPP_NUMBER || '8801629411444'}`} className="flex items-center gap-2 hover:text-white transition-colors group">
                <svg viewBox="0 0 24 24" width="16" height="16" fill="currentColor" className="text-emerald-500 group-hover:text-emerald-400">
